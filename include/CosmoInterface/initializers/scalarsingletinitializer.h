...
namespace TempLat
{
  ...
  public:
    ...
    /**
     * @brief Initializes the scalar singlet fields and their derivatives with Gaussian fluctuations sampled from a known power spectrum or an external input one, according to the
     ...
     * @param extps The fluctuations generator to use for creating the initial fluctuations from a external input power spectrum.
    ...
    static void initializeScalars(Model &model, const FluctuationsGenerator<T> &fg, const ExternalPowerSpectrumInitializer<T>& extps, T kCutOff, int PSType)
    {
