...
namespace TempLat
{
  ...
  template <typename T> class RK2NStorageParameters
  {
  public:
    ...
    static std::vector<T> getAs(EvolverType eType)
    {
      ...
      if (eType == RK2)
        ...
        res = {0, -5.0 / 9.0, -153.0 / 128.0};
      else if (eType == RK3_4)
        res = {0, -0.7825460361923583, -2.042914325731225, -1.799337253940777};
      else if (eType == RK4_5)
        res = {0, -567301805773.0 / 1357537059087.0, -2404267990393.0 / 2016746695238.0,
    ...
    static std::vector<T> getBs(EvolverType eType)
    {
      ...
      if (eType == RK2)
        ...
        res = {1.0 / 3.0, 15.0 / 16.0, 8.0 / 15.0};
      else if (eType == RK3_4)
        res = {0.06688758201974097, 2.876554598956719, 0.5534657361343982, 0.3912730180961791};
      else if (eType == RK4_5)
        res = {1432997174477.0 / 9575080441755.0, 5161836677717.0 / 13612068292357.0, 1720146321549.0 / 2090206949498.0,
    ...
    static std::vector<T> getCs(EvolverType eType)
    {
      ...
      if (eType == RK2)
        ...
        res = {0.0, 1.0 / 3.0, 3.0 / 4.0};
      else if (eType == RK3_4)
        res = {0.0, 0.06688758201974097, 0.6924057816719806, 1.0};
      else if (eType == RK4_5)
        res = {0.0, 1432997174477.0 / 9575080441755.0, 0.37040095736420475, 0.6222557631344432, 0.9582821306746903};
