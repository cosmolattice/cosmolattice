#ifndef TANHPP2_H // Usual macro guard to prevent multiple inclusion
#define TANHPP2_H
...
#define MODELNAME tanhpp2
  ...
  public:
    ...
    {
      return 4 * (2 - cosh(2 * fldS(0_c) * phii / M)) * pow<2>(tanh(fldS(0_c) * phii / M)) /
                 pow<2>(sinh(2 * fldS(0_c) * phii / M)) +
             q * fldS(1_c) * fldS(1_c);
    }
