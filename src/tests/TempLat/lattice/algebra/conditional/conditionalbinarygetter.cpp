...
void ConditionalBinaryGetterTester::Test(TDDAssertion &tdd)
{
  ...
  using A = Operators::Multiplication<
      Operators::Cosine<Operators::Multiplication<double, Field<3UL, double>>>,
      ExpressionShifterByOne<Field<3UL, double>, 1>>;

  using B = Operators::Multiplication<
      Operators::Sine<Operators::Multiplication<double, Field<3UL, double>>>,
      ExpressionShifterByOne<Field<3UL, double>, 1>>;
