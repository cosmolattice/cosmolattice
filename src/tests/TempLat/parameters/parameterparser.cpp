...
namespace TempLat
{
  ...
  void ParameterParserTester::Test(TDDAssertion &tdd)
  {
   ...
   program name std::cout<<"Parameters: "<<test;
    ...
    auto myOptInt5 = test.get<int, 0>("iii5"); //Just to make sure it does not crash even if mandatory. Useful if the
   size of array depends on templated size that can be zero.
