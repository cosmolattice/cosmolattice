#ifndef LPH4_H //Usual macro guard to prevent multiple inclusion
#define LPH4_H
...
//         fldGWs0 = parser.get<double, 6>("initial_amplitudes_gws", {0, 0, 0, 0, 0, 0});
//         piGWs0 = parser.get<double, 6>("initial_momenta_gws", {0, 0, 0, 0, 0, 0});
