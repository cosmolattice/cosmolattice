...
if((CUDA OR HIP)
  ...
  execute_process(
    ...
    -DCMAKE_CXX_STANDARD:STRING=${CMAKE_CXX_STANDARD} \
      ../heffte-repo &> ${CMAKE_CURRENT_BINARY_DIR}/heffte_config.log"
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/_dep/heffte-bin)

  message(STATUS "Building heffte...")
  execute_process(
    COMMAND bash -c "make -j &>> ${CMAKE_CURRENT_BINARY_DIR}/heffte_build.log"
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/_dep/heffte-bin)

  message(STATUS "Installing heffte...")
  execute_process(
    COMMAND bash -c
            "make install &>> ${CMAKE_CURRENT_BINARY_DIR}/heffte_install.log"
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/_dep/heffte-bin)
else()
  set(HEFFTE OFF)
endif()
