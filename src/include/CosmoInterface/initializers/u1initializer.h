    ...
    private:
        ...
        static void addFluctuationsCScalarFromPhases(Model& model, std::string baseSeed, FluctuationsGenerator<T>& fg, T aDot, T kCutOff){
            ...
            ForLoop(i, 0, Model::NCs - 1,
                    ...
                    auto a0 = fFluctuationNorm0 * RandomRealGaussianField<T>(baseSeed + "norm0" + model.fldCS(i)(0_c).toString(),toolBox); // component 0
                    auto a1 = fFluctuationNorm1 * RandomRealGaussianField<T>(baseSeed + "norm1" + model.fldCS(i)(1_c).toString(),toolBox);  // component 1
                    ...
                    auto omega0 = fg.omega_k(k,model.masses2CS(i)(0_c));  // omega^2 = k^2 + m^2
