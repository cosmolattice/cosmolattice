...
#ifndef INSIDE_TempLat_UTIL_HASH_LIBKECCAK_TWOENDIANS_H
 ...
 *                             - If the 2-bit sequence 0,1 is to be appended (as for SHA3-*), @a delimitedSuffix must be
 * 0x06.
 *                             - If the 4-bit sequence 1,1,1,1 is to be appended (as for SHAKE*), @a delimitedSuffix
 * must be 0x1F.
...
/** @brief WV: turned this in a class for lazy inlining. */
struct TrueKeccak {
