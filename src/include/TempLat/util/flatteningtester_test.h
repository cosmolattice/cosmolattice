...
struct dummy1 {
  ...
  template <int N> auto SU2Get(TempLat::Tag<N> t) { return N; }
...
struct dummy2 {
  ...
  template <int N> auto getComp(TempLat::Tag<N> t) { return dummy1(); }
...
struct dummy3 {
  ...
  template <int N> auto getComp(TempLat::Tag<N> t) { return dummy2(); }
