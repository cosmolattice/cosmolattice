...
namespace TempLat
{
  ...
  template <typename F, typename G> class static_if_helper<F, G, false>
  {
  public:
    static_if_helper(const F &pF, const G &pG) : f(pF), g(pG) {}
  ...
  template <bool B, class F, class G> auto static_if(const F &f, const G &g)
  {
    return TempLat::static_if_helper<F, G, B>(f, g)();
  }

  template <typename F, typename G, bool B> class static_if_statement_helper
  {
  public:
  ...
  template <typename F, typename G> class static_if_statement_helper<F, G, false>
  {
  public:
    static_if_statement_helper(const F &pF, const G &pG) : f(pF), g(pG) {}
  ...
  template <bool B, class F, class G> auto static_if_statement(const F &f, const G &g)
  {
...
#define IfElseStatement(condition, ifExpr, elseExpr)                                                                   \
  static_if_statement<condition>([&]() { ifExpr; }, [&]() { elseExpr; })
