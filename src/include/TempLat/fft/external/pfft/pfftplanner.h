...
namespace TempLat
{
  ...
  public:
                                                                          ...
                                                                          const FFTLayoutStruct<NDim> &layout)
    {
      ...
      auto c2r =
          pfftf_plan_dft_c2r(layout.getNDimensions(), layout.configurationSpace.getGlobalSizes().data(),
                             (pfftf_complex *)(float *)temp, (float *)temp, group.getComm_onlyDividedDimensions(),
                             PFFT_BACKWARD, PFFT_PADDED_C2R | PFFT_MEASURE | trFlags.c2r());
      auto r2c =

          pfftf_plan_dft_r2c(layout.getNDimensions(), layout.configurationSpace.getGlobalSizes().data(), (float *)temp,
                             (pfftf_complex *)(float *)temp, group.getComm_onlyDividedDimensions(), PFFT_FORWARD,
                                                                            ...
                                                                            const FFTLayoutStruct<NDim> &layout)
    {
      ...
      // << "\n";
      auto c2r =
          pfft_plan_dft_c2r(layout.getNDimensions(), layout.configurationSpace.getGlobalSizes().data(),
                            (pfft_complex *)(double *)temp, (double *)temp, group.getComm_onlyDividedDimensions(),
                            PFFT_BACKWARD, PFFT_PADDED_C2R | PFFT_MEASURE | trFlags.c2r());
      auto r2c =
          pfft_plan_dft_r2c(layout.getNDimensions(), layout.configurationSpace.getGlobalSizes().data(), (double *)temp,
                            (pfft_complex *)(double *)temp, group.getComm_onlyDividedDimensions(), PFFT_FORWARD,
                            PFFT_PADDED_R2C | PFFT_MEASURE | trFlags.r2c());

      if (r2c == NULL || c2r == NULL) {
        throw PFFTPlannerException("Got NULL plans from pfft.", "c2r", c2r, "r2c", r2c, "layout", layout, "memory",
                                   temp);
      }
