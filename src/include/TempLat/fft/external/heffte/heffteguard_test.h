#ifndef TEMPLAT_FFT_EXTERNAL_HEFFTE_GUARD_TEST_H
#define TEMPLAT_FFT_EXTERNAL_HEFFTE_GUARD_TEST_H
...
// inline void ThisShouldNotCompile() { TempLat::HEFFTEGuard guard; }

inline void TempLat::HEFFTEGuard::Test(TempLat::TDDAssertion &tdd)
{
