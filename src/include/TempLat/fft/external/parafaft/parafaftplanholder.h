...
say << "ParafaftPlanHolder is correctly being destructed.\n";
    ...
    private:
...
#ifndef NOMPI
#ifndef NOPARAFAFT
            double* real_ptr = mBlock.ptr();
            Complex* complex_ptr = reinterpret_cast<Complex*>(mBlock.ptr());
            mParafaft->forward(real_ptr, complex_ptr);
#endif
#endif
        }
        ...
        execute_c2r(MemoryBlock<S> &mBlock) {
            ...
            double* real_ptr = mBlock.ptr();
            Complex* complex_ptr = reinterpret_cast<Complex*>(mBlock.ptr());
            mParafaft->backward(complex_ptr, real_ptr);
#endif
#endif
        }
