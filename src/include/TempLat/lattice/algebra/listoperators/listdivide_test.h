#ifndef TEMPLAT_LATTICE_ALGEBRA_OPERATORS_LISTOPERATORS_LISTDIVIDE_TEST_H
#define TEMPLAT_LATTICE_ALGEBRA_OPERATORS_LISTOPERATORS_LISTDIVIDE_TEST_H
...
inline void TempLat::ListDivisionTester::Test(TempLat::TDDAssertion& tdd) {
