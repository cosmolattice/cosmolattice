...
namespace TempLat
{
  ...
  public:
    ...
    MemoryToolBox(ptrdiff_t nDimensions, ptrdiff_t nGridPoints, ptrdiff_t ghostDepth, bool forbidTransposition = false)
        : MemoryToolBox(FFTMPIDomainSplit::makeMPIGroup(nDimensions), nDimensions, nGridPoints, ghostDepth,
                        forbidTransposition)
    {
    }
    /** \brief Shared-pointer constructor with default MPI layout and MPI_COMM_WORLD. */
    static inline std::shared_ptr<MemoryToolBox> makeShared(ptrdiff_t nDimensions, ptrdiff_t nGridPoints,
                                                            ptrdiff_t ghostDepth, bool forbidTransposition = false)
    {
    ...
    /** \brief Shared-pointer constructor with default MPI layout and MPI_COMM_WORLD. */
    static inline std::shared_ptr<MemoryToolBox> makeShared(std::vector<ptrdiff_t> nGrid, ptrdiff_t ghostDepth,
    ...
    MemoryToolBox(ptrdiff_t nDimensions, ptrdiff_t nGridPoints, ptrdiff_t ghostDepth, ptrdiff_t nThreads,
                  bool forbidTransposition)
        : MemoryToolBox(FFTMPIDomainSplit::makeMPIGroup(nDimensions), nDimensions, nGridPoints, ghostDepth, nThreads,
                        forbidTransposition)
    {
    }
    /** \brief Shared-pointer constructor with default MPI layout and MPI_COMM_WORLD. */
    ...
    MemoryToolBox(MPICommReference comm, ptrdiff_t nDimensions, ptrdiff_t nGridPoints, ptrdiff_t ghostDepth,
                  bool forbidTransposition = false)
        : MemoryToolBox(FFTMPIDomainSplit::makeMPIGroup(comm, nDimensions), nDimensions, nGridPoints, ghostDepth,
                        forbidTransposition)
    {
    }
    /** \brief Shared-pointer constructor with default MPI layout and but custom MPI_Comm. */
    static inline std::shared_ptr<MemoryToolBox> makeShared(MPICommReference comm, ptrdiff_t nDimensions,
                                                            ptrdiff_t nGridPoints, ptrdiff_t ghostDepth,
                                                            bool forbidTransposition = false)
    {
    ...
    /** \brief Shared-pointer constructor with default MPI layout and but custom MPI_Comm. */
    static inline std::shared_ptr<MemoryToolBox> makeShared(MPICommReference comm, std::vector<ptrdiff_t> nGrid,
                                                            ptrdiff_t ghostDepth, bool forbidTransposition = false)
    {
    ...
    MemoryToolBox(MPICartesianGroup group, ptrdiff_t nDimensions, ptrdiff_t nGridPoints, ptrdiff_t ghostDepth,
                  bool forbidTransposition = false)
    ...
    static inline std::shared_ptr<MemoryToolBox> makeShared(MPICartesianGroup group, ptrdiff_t nDimensions,
                                                            ptrdiff_t nGridPoints, ptrdiff_t ghostDepth,
                                                            bool forbidTransposition = false)
    {
    ...
    /** \brief Shared-pointer constructor with user chosen MPI layout. */
    static inline std::shared_ptr<MemoryToolBox> makeShared(MPICartesianGroup group, std::vector<ptrdiff_t> nGrid,
                                                            ptrdiff_t ghostDepth, bool forbidTransposition = false)
    {
    ...
    MemoryToolBox(MPICartesianGroup group, ptrdiff_t nDimensions, ptrdiff_t nGridPoints, ptrdiff_t ghostDepth,
                  ptrdiff_t nThreads, bool forbidTransposition = false)
        : MemoryToolBox(group, std::vector<ptrdiff_t>(nDimensions, nGridPoints), ghostDepth, nThreads,
                        forbidTransposition)
    {
    }
    ...
    MemoryToolBox(MPICartesianGroup group, std::vector<ptrdiff_t> nGrid, ptrdiff_t ghostDepth, ptrdiff_t nThreads,
                  bool forbidTransposition = false)
        : mGroup(group), mNDimensions(nGrid.size()),
