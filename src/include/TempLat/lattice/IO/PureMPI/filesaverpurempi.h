...
namespace TempLat
{
  ...
  public:
    ...
    { // used to store an entity in a time series. The name is the one of te group, data set labelled by t.
      throw PureMPISaverNotImplemented(
          "The pure MPI IO interface is yet to be implemented. If you require I/O for your lattice, please use the "
          "HighFive/HDF5 interface. If you don't, then just disable the options/functions which requires I/O");
    }
    ...
    template <typename Float, typename R> void save(Float t, R &&r)
    {
      throw PureMPISaverNotImplemented(
          "The pure MPI IO interface is yet to be implemented. If you require I/O for your lattice, please use the "
          "HighFive/HDF5 interface. If you don't, then just disable the options/functions which requires I/O");
