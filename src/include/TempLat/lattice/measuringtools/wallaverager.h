...
namespace TempLat {
        ...
        public:
            ...
            WallAverager(const T& pT,SpaceStateInterface::SpaceType spaceType):
                    mT(pT),
            ...
            void compute() 
            {
                ...
                if(mSpaceType ==SpaceStateInterface::SpaceType::Fourier) throw AveragerWrongSpace("Wall averager works only in configuration space.");
            ...
            std::string toString() const {
                return "<" + GetString::get(mT) + ">_walls";
            }
