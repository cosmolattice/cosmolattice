...
url=https://arxiv.org/src/2512.15627
archive=art_i_archive.tar.gz
code_dir="${base_dir}/../"
...
cd "${base_dir}/scripts/"
python "${base_dir}/scripts/split.py" "${tmp_dir}/source/main.tex" "${doc_dir}" "${tmp_dir}/" "${manual_name}"
