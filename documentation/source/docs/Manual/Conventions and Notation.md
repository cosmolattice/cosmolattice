...
In the very specific case of gauge fields coupled to a fluid, however, it is possible to consider an alternative formulation where the gauge fields are *collocated*, i.e. living at integer lattice sites $A_\mu \equiv A_\mu(n)$.
