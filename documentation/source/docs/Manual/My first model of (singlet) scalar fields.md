...
`CMakeLists.txt:` \inputminted[ firstline=50, lastline=53,linenos, frame=single]{CMake}{code_files/CMakeLists.txt}
...
`src/models/parameter-files/lphi4.in:`\inputminted[frame=single,linenos]{text}{code_files/lphi4.in}
