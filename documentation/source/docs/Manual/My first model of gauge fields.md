...
```math
\begin{align}
S \hspace*{-0.18cm}&=\hspace*{-0.18cm} - \int d^4 x \left\{\frac{1}{2}\partial_{\mu} \phi \partial ^{\mu}\phi + (D_{\mu}^A \varphi)^{*}(D_A^{\mu} \varphi) +  (D_{\mu}\Phi )^{\dagger} (D^{\mu} \Phi) + \frac{1}{4} F_{\mu \nu} F^{\mu \nu} + \frac{1}{2}{\rm Tr}\{G_{\mu \nu}G^{\mu \nu}\} + V(\phi,|\varphi|, |\Phi|) \right\}  ,  \\
\tag{50}
\end{align}
```
...
```math
\tag{55}
\mathcal{E}_i \equiv F_{0i} ,           \mathcal{B}_i = \frac{1}{2} \epsilon_{i j k} F^{j k} ,            \mathcal{E}_i^a \equiv G_{0i}^a ,           \mathcal{B}_i^a = \frac{1}{2} \epsilon_{i j k} G^{j k}_a  ,
```
...
\begin{align}
\tag{65}
\hspace{1.8cm} \widetilde J_A^\mu &= 2 g_AQ_A^{(\varphi)} \mathcal{I}m [ \tilde \varphi^{*} ( \widetilde{D}_A^{\mu} \tilde \varphi )] + 2 g_AQ_A^{(\Phi)} \mathcal{I}m [ \widetilde \Phi^\dag (\widetilde D^{\mu} \widetilde \Phi  )] ,\\
\tag{66}
\hspace{1.8cm} \widetilde J_a^\mu &= 2g_BQ_B\mathcal{I}m [ \widetilde \Phi^{\dag} T_a( \widetilde{D}^{\mu} \widetilde \Phi )] .
\end{align}
```
...
\\
\widetilde {K}_{\Phi} &= \frac{1}{a^{2\alpha} } (\widetilde D_0 \widetilde \Phi )^\dag(\widetilde D_0 \widetilde \Phi)
\\
\end{array}
...
\\
\widetilde {G}_{\Phi} &= \frac{1}{a^2} \sum_i (\widetilde  D_i\widetilde  \Phi)^\dag(\widetilde D_i \widetilde \Phi)
\\
\end{array}
\hspace{0.1cm};\hspace{0.3cm}
\begin{array}{lcl}
