...
Here we list all INSPIRE-HEP records that cite the $\mathcal{C}\mathtt{osmo}\mathcal{L}\mathtt{attice}$ code paper.
The list includes articles, theses, and other scholarly works.
